...
pub fn nop(_x86: &mut X86, _instr: &Instruction) -> Result<()> {
    Ok(())
}

pub fn enterd_imm16_imm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
...
pub fn leaved(x86: &mut X86, _instr: &Instruction) -> Result<()> {
    x86.regs.esp = x86.regs.ebp;
    x86.regs.ebp = pop(x86);
    Ok(())
}

pub fn pushd_imm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    push(x86, instr.immediate8to32() as u32);
    Ok(())
}

pub fn pushd_imm32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    push(x86, instr.immediate32());
    Ok(())
}

pub fn push_r32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    push(x86, x86.regs.get32(instr.op0_register()));
    Ok(())
}

pub fn push_rm32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = op0_rm32(x86, instr);
    push(x86, value);
    Ok(())
}

pub fn push_rm16(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = op0_rm16(x86, instr);
    push16(x86, value);
    Ok(())
}

pub fn pop_rm32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = pop(x86);
    rm32_x(x86, instr, |_x86, _x| value);
    Ok(())
}

pub fn pop_rm16(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = pop16(x86);
    rm16_x(x86, instr, |_x86, _x| value);
    Ok(())
}

pub fn mov_rm32_imm32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    // mov dword ptr [x], y
...
pub fn mov_r32_imm32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    x86.regs.set32(instr.op0_register(), instr.immediate32());
    Ok(())
}

pub fn mov_moffs32_eax(x86: &mut X86, instr: &Instruction) -> Result<()> {
    // mov [x],eax
    x86.write_u32(x86_addr(x86, instr), x86.regs.eax);
    Ok(())
}

pub fn mov_eax_moffs32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    // mov eax,[x]
    x86.regs.eax = x86.read_u32(x86_addr(x86, instr));
    Ok(())
}

pub fn mov_rm32_r32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = x86.regs.get32(instr.op1_register());
    rm32_x(x86, instr, |_x86, _x| value);
    Ok(())
}

pub fn mov_r32_rm32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = op1_rm32(x86, instr);
    x86.regs.set32(instr.op0_register(), value);
    Ok(())
}

pub fn mov_r16_rm16(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = op1_rm16(x86, instr);
    x86.regs.set16(instr.op0_register(), value);
    Ok(())
}

pub fn mov_rm16_r16(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = x86.regs.get16(instr.op1_register());
    rm16_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn mov_r8_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = op1_rm8(x86, instr);
    x86.regs.set8(instr.op0_register(), value);
    Ok(())
}

pub fn mov_rm8_r8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = x86.regs.get8(instr.op1_register());
    rm8_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn mov_rm8_imm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = instr.immediate8();
    rm8_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn movsx_r32_rm16(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = op1_rm16(x86, instr) as i16 as u32;
    rm32_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn movsx_r32_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = op1_rm8(x86, instr) as i8 as u32;
    rm32_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn movsx_r16_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = op1_rm8(x86, instr) as i8 as u16;
    rm16_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn movzx_r32_rm16(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = op1_rm16(x86, instr) as u32;
    rm32_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn movzx_r32_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = op1_rm8(x86, instr) as u32;
    rm32_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn movzx_r16_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let y = op1_rm8(x86, instr) as u16;
    rm16_x(x86, instr, |_x86, _x| y);
    Ok(())
}

pub fn xchg_rm32_r32(x86: &mut X86, instr: &Instruction) -> Result<()> {
...
pub fn cmpxchg_rm32_r32(x86: &mut X86, instr: &Instruction) -> Result<()> {
...
pub fn lea_r32_m(x86: &mut X86, instr: &Instruction) -> Result<()> {
    // lea eax,[esp+10h]
    x86.regs.set32(instr.op0_register(), x86_addr(x86, instr));
    Ok(())
}

pub fn sete_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = x86.regs.flags.contains(Flags::ZF) as u8;
    rm8_x(x86, instr, |_x86, _x| value);
    Ok(())
}

pub fn setne_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = !x86.regs.flags.contains(Flags::ZF) as u8;
    rm8_x(x86, instr, |_x86, _x| value);
    Ok(())
}

pub fn setge_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let value = (x86.regs.flags.contains(Flags::ZF) == x86.regs.flags.contains(Flags::OF)) as u8;
    rm8_x(x86, instr, |_x86, _x| value);
    Ok(())
}

pub fn pushad(x86: &mut X86, _instr: &Instruction) -> Result<()> {
...
pub fn popad(x86: &mut X86, _instr: &Instruction) -> Result<()> {
...
pub fn pushfd(x86: &mut X86, _instr: &Instruction) -> Result<()> {
    push(x86, x86.regs.flags.bits());
    Ok(())
}

pub fn pushfw(x86: &mut X86, _instr: &Instruction) -> Result<()> {
    let value = (x86.regs.flags.bits() & 0x0000_FFFF) as u16;
    push16(x86, value);
    Ok(())
}

pub fn popfd(x86: &mut X86, _instr: &Instruction) -> Result<()> {
    x86.regs.flags = Flags::from_bits(pop(x86)).unwrap();
    Ok(())
}

pub fn popfw(x86: &mut X86, _instr: &Instruction) -> Result<()> {
...
pub fn sahf(x86: &mut X86, _instr: &Instruction) -> Result<()> {
    let ah = (x86.regs.eax >> 8) as u8;
    x86.regs.flags = Flags::from_bits((x86.regs.flags.bits() & 0xFFFF_FF00) | ah as u32).unwrap();
    Ok(())
}

pub fn std(x86: &mut X86, _instr: &Instruction) -> Result<()> {
    x86.regs.flags.insert(Flags::DF);
    Ok(())
}

pub fn cld(x86: &mut X86, _instr: &Instruction) -> Result<()> {
    x86.regs.flags.remove(Flags::DF);
    Ok(())
}

pub fn cwde(x86: &mut X86, _instr: &Instruction) -> Result<()> {
    x86.regs.eax = x86.regs.eax as i16 as i32 as u32;
    Ok(())
}

pub fn cdq(x86: &mut X86, _instr: &Instruction) -> Result<()> {
