...
pub fn cmp_rm32_r32(x86: &mut X86, instr: &Instruction) -> Result<()> {
...
pub fn cmp_r32_rm32(x86: &mut X86, instr: &Instruction) -> Result<()> {
...
pub fn cmp_rm32_imm32(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let x = op0_rm32(x86, instr);
...
pub fn cmp_rm32_imm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let x = op0_rm32(x86, instr);
...
pub fn cmp_rm16_rm16(x86: &mut X86, instr: &Instruction) -> Result<()> {
...
pub fn cmp_rm16_imm16(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let x = op0_rm16(x86, instr);
...
pub fn cmp_rm16_imm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let x = op0_rm16(x86, instr);
...
pub fn cmp_rm8_imm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
...
pub fn cmp_rm8_r8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let x = op0_rm8(x86, instr);
...
pub fn cmp_r8_rm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
...
pub fn bt_rm32_imm8(x86: &mut X86, instr: &Instruction) -> Result<()> {
    let x = op0_rm32(x86, instr);
