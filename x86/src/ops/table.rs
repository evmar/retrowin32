...
pub unsafe fn init_op_tab() {
    ...
    OP_TAB[iced_x86::Code::Cmpxchg8b_m64 as usize] = Some(ops::cmpxchg8b_m64);

    OP_TAB[iced_x86::Code::Cmpsd_m32_m32 as usize] = Some(ops::cmpsd);
    OP_TAB[iced_x86::Code::Cmpsw_m16_m16 as usize] = Some(ops::cmpsw);
    OP_TAB[iced_x86::Code::Cmpsb_m8_m8 as usize] = Some(ops::cmpsb);
    ...
    OP_TAB[iced_x86::Code::And_rm8_r8 as usize] = Some(ops::and_rm8_r8);
    ...
    OP_TAB[iced_x86::Code::Shld_rm32_r32_imm8 as usize] = Some(ops::shld_rm32_r32_imm8);
    OP_TAB[iced_x86::Code::Shld_rm32_r32_CL as usize] = Some(ops::shld_rm32_r32_cl);
    ...
    OP_TAB[iced_x86::Code::Shr_rm8_CL as usize] = Some(ops::shr_rm8_cl);

    OP_TAB[iced_x86::Code::Shrd_rm32_r32_imm8 as usize] = Some(ops::shrd_rm32_r32_imm8);
    OP_TAB[iced_x86::Code::Shrd_rm32_r32_CL as usize] = Some(ops::shrd_rm32_r32_cl);
    ...
    OP_TAB[iced_x86::Code::Sar_rm8_CL as usize] = Some(ops::sar_rm8_cl);

    OP_TAB[iced_x86::Code::Rol_rm32_CL as usize] = Some(ops::rol_rm32_cl);
    ...
    OP_TAB[iced_x86::Code::Rol_rm8_CL as usize] = Some(ops::rol_rm8_cl);
    ...
    OP_TAB[iced_x86::Code::Ror_rm8_CL as usize] = Some(ops::ror_rm8_cl);
    ...
    OP_TAB[iced_x86::Code::Xor_r16_rm16 as usize] = Some(ops::xor_rm16_rm16);
    OP_TAB[iced_x86::Code::Xor_rm16_r16 as usize] = Some(ops::xor_rm16_rm16);
    ...
    OP_TAB[iced_x86::Code::Add_rm16_r16 as usize] = Some(ops::add_rm16_rm16);
    OP_TAB[iced_x86::Code::Add_r16_rm16 as usize] = Some(ops::add_rm16_rm16);
    ...
    OP_TAB[iced_x86::Code::Adc_rm16_imm8 as usize] = Some(ops::adc_rm16_imm8);
    ...
    OP_TAB[iced_x86::Code::Sub_r16_rm16 as usize] = Some(ops::sub_rm16_rm16);
    OP_TAB[iced_x86::Code::Sub_rm16_r16 as usize] = Some(ops::sub_rm16_rm16);
    ...
    OP_TAB[iced_x86::Code::Mul_rm16 as usize] = Some(ops::mul_rm16);
    OP_TAB[iced_x86::Code::Mul_rm8 as usize] = Some(ops::mul_rm8);
    OP_TAB[iced_x86::Code::Imul_rm32 as usize] = Some(ops::imul_rm32);
    OP_TAB[iced_x86::Code::Imul_rm16 as usize] = Some(ops::imul_rm16);
    OP_TAB[iced_x86::Code::Imul_rm8 as usize] = Some(ops::imul_rm8);
    ...
    OP_TAB[iced_x86::Code::Idiv_rm16 as usize] = Some(ops::idiv_rm16);
    OP_TAB[iced_x86::Code::Idiv_rm8 as usize] = Some(ops::idiv_rm8);
    OP_TAB[iced_x86::Code::Div_rm32 as usize] = Some(ops::div_rm32);
    OP_TAB[iced_x86::Code::Div_rm16 as usize] = Some(ops::div_rm16);
    OP_TAB[iced_x86::Code::Div_rm8 as usize] = Some(ops::div_rm8);
    ...
    OP_TAB[iced_x86::Code::Not_rm16 as usize] = Some(ops::not_rm16);
    OP_TAB[iced_x86::Code::Not_rm8 as usize] = Some(ops::not_rm8);
    ...
    OP_TAB[iced_x86::Code::Test_rm16_imm16 as usize] = Some(ops::test_rm16_imm16);
    ...
    OP_TAB[iced_x86::Code::Setbe_rm8 as usize] = Some(ops::setbe_rm8);
    ...
    // OP_TAB[iced_x86::Code::Fisp_m64int as usize] = Some(ops::fist_m64int);
    OP_TAB[iced_x86::Code::Fist_m32int as usize] = Some(ops::fist_m32int);
    // OP_TAB[iced_x86::Code::Fist_m16int as usize] = Some(ops::fist_m16int);
    ...
    OP_TAB[iced_x86::Code::Fisub_m32int as usize] = Some(ops::fisub_m32int);
    ...
    OP_TAB[iced_x86::Code::Fdiv_sti_st0 as usize] = Some(ops::fdiv_sti_sti);
    OP_TAB[iced_x86::Code::Fdiv_st0_sti as usize] = Some(ops::fdiv_sti_sti);
    OP_TAB[iced_x86::Code::Fdivp_sti_st0 as usize] = Some(ops::fdivp_sti_sti);
    OP_TAB[iced_x86::Code::Fidiv_m32int as usize] = Some(ops::fidiv_m32int);
    OP_TAB[iced_x86::Code::Fidiv_m16int as usize] = Some(ops::fidiv_m16int);
    ...
    OP_TAB[iced_x86::Code::Fcom_m32fp as usize] = Some(ops::fcom_m32fp);
    ...
    OP_TAB[iced_x86::Code::Clc as usize] = Some(ops::clc);
    ...
    OP_TAB[iced_x86::Code::Tzcnt_r32_rm32 as usize] = Some(ops::tzcnt_r32_rm32);
