...
pub unsafe fn init_op_tab() {
    ...
    OP_TAB[iced_x86::Code::Cmpxchg_rm8_r8 as usize] = Some(cmpxchg_rm8_r8);
    ...
    OP_TAB[iced_x86::Code::And_r16_rm16 as usize] = Some(and_r16_rm16);
    OP_TAB[iced_x86::Code::And_rm8_r8 as usize] = Some(and_rm8_rm8);
    OP_TAB[iced_x86::Code::And_r8_rm8 as usize] = Some(and_rm8_rm8);
    ...
    OP_TAB[iced_x86::Code::Or_rm16_imm8 as usize] = Some(or_rm16_imm8);
    OP_TAB[iced_x86::Code::Or_rm16_r16 as usize] = Some(or_rm16_rm16);
    OP_TAB[iced_x86::Code::Or_r16_rm16 as usize] = Some(or_rm16_rm16);
    OP_TAB[iced_x86::Code::Or_rm8_r8 as usize] = Some(or_rm8_rm8);
    ...
    OP_TAB[iced_x86::Code::Sbb_rm32_imm32 as usize] = Some(sbb_rm32_imm32);
    ...
    OP_TAB[iced_x86::Code::Dec_rm16 as usize] = Some(dec_rm16);
    ...
    OP_TAB[iced_x86::Code::Test_AX_imm16 as usize] = Some(test_rm16_imm16);
    ...
    OP_TAB[iced_x86::Code::Sets_rm8 as usize] = Some(sets_rm8);
    ...
    OP_TAB[iced_x86::Code::Fcom_m64fp as usize] = Some(fcom_m32fp);
    ...
    OP_TAB[iced_x86::Code::Psrad_mm_imm8 as usize] = Some(psrad_mm_imm8);
    OP_TAB[iced_x86::Code::Psrlw_mm_imm8 as usize] = Some(psrlw_mm_imm8);
    OP_TAB[iced_x86::Code::Psrlq_mm_imm8 as usize] = Some(psrlq_mm_imm8);
