...
const OP_TAB: [Option<OpImp>; 2553] = {
    ...
    use super::{
        basic::*, bits::*, control::*, cpuid::*, flags::*, fpu::*, math::*, mmx::*, mov::*,
        stack::*, string::*, test::*,
    };
    ...
    tab[iced_x86::Code::Jno_rel32_32 as usize] = Some(jno);
    tab[iced_x86::Code::Jno_rel8_32 as usize] = Some(jno);
    tab[iced_x86::Code::Jnp_rel32_32 as usize] = Some(jnp);
    tab[iced_x86::Code::Jnp_rel8_32 as usize] = Some(jnp);
    tab[iced_x86::Code::Jns_rel32_32 as usize] = Some(jns);
    tab[iced_x86::Code::Jns_rel8_32 as usize] = Some(jns);
    tab[iced_x86::Code::Jo_rel32_32 as usize] = Some(jo);
    tab[iced_x86::Code::Jo_rel8_32 as usize] = Some(jo);
    ...
    tab[iced_x86::Code::Xadd_rm32_r32 as usize] = Some(xadd_rm32_r32);
    ...
    tab[iced_x86::Code::Xor_rm16_imm8 as usize] = Some(xor_rm16_imm8);
    ...
    tab[iced_x86::Code::Sbb_r8_rm8 as usize] = Some(sbb_rm8_rm8);
    tab[iced_x86::Code::Sbb_rm8_r8 as usize] = Some(sbb_rm8_rm8);
    tab[iced_x86::Code::Sbb_rm8_imm8 as usize] = Some(sbb_rm8_imm8);
    tab[iced_x86::Code::Sbb_AL_imm8 as usize] = Some(sbb_rm8_imm8);
    ...
    tab[iced_x86::Code::Fcompp as usize] = Some(fcompp);
    ...
    tab[iced_x86::Code::Fnsave_m108byte as usize] = Some(nop);
    tab[iced_x86::Code::Frstor_m108byte as usize] = Some(nop);
