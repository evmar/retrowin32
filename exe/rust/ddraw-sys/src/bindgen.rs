...
pub type LPDDENUMMODESCALLBACK = ::std::option::Option<
    unsafe extern "stdcall" fn(arg1: LPDDSURFACEDESC, arg2: LPVOID) -> HRESULT,
>;
pub type LPDDENUMSURFACESCALLBACK = ::std::option::Option<
    unsafe extern "stdcall" fn(
...
pub struct IDirectDrawVtbl {
    ...
    >,
    pub AddRef: ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDraw) -> ULONG>,
    pub Release: ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDraw) -> ULONG>,
    pub Compact:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDraw) -> HRESULT>,
    pub CreateClipper: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDraw,
            arg1: DWORD,
    ...
    >,
    pub CreatePalette: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDraw,
            arg1: DWORD,
            arg2: LPPALETTEENTRY,
    ...
    >,
    pub DuplicateSurface: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDraw,
            arg1: LPDIRECTDRAWSURFACE,
            arg2: *mut LPDIRECTDRAWSURFACE,
    ...
    >,
    pub EnumDisplayModes: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDraw,
            arg1: DWORD,
            arg2: LPDDSURFACEDESC,
    ...
    >,
    pub EnumSurfaces: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDraw,
            arg1: DWORD,
            arg2: LPDDSURFACEDESC,
    ...
    >,
    pub GetFourCCCodes: ::std::option::Option<
        unsafe extern "stdcall" fn(This: *mut IDirectDraw, arg1: LPDWORD, arg2: LPDWORD) -> HRESULT,
    >,
    pub GetGDISurface: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDraw,
            arg1: *mut LPDIRECTDRAWSURFACE,
        ) -> HRESULT,
    >,
    pub GetMonitorFrequency: ::std::option::Option<
        unsafe extern "stdcall" fn(This: *mut IDirectDraw, arg1: LPDWORD) -> HRESULT,
    >,
    pub GetScanLine: ::std::option::Option<
        unsafe extern "stdcall" fn(This: *mut IDirectDraw, arg1: LPDWORD) -> HRESULT,
    >,
    pub GetVerticalBlankStatus: ::std::option::Option<
    ...
    pub RestoreDisplayMode:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDraw) -> HRESULT>,
    pub SetCooperativeLevel: ::std::option::Option<
    ...
    >,
    pub WaitForVerticalBlank: ::std::option::Option<
...
pub struct IDirectDrawPaletteVtbl {
    ...
    >,
    pub AddRef:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDrawPalette) -> ULONG>,
    pub Release:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDrawPalette) -> ULONG>,
    pub GetCaps: ::std::option::Option<
        unsafe extern "stdcall" fn(This: *mut IDirectDrawPalette, arg1: LPDWORD) -> HRESULT,
    >,
    pub GetEntries: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawPalette,
            arg1: DWORD,
            arg2: DWORD,
    ...
    >,
    pub SetEntries: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawPalette,
            arg1: DWORD,
            arg2: DWORD,
...
pub struct IDirectDrawClipperVtbl {
    ...
    >,
    pub AddRef:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDrawClipper) -> ULONG>,
    pub Release:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDrawClipper) -> ULONG>,
    pub GetClipList: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawClipper,
            arg1: LPRECT,
            arg2: LPRGNDATA,
...
pub struct IDirectDrawSurfaceVtbl {
    ...
    >,
    pub AddRef:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDrawSurface) -> ULONG>,
    pub Release:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDrawSurface) -> ULONG>,
    pub AddAttachedSurface: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LPDIRECTDRAWSURFACE,
        ) -> HRESULT,
    >,
    pub AddOverlayDirtyRect: ::std::option::Option<
        unsafe extern "stdcall" fn(This: *mut IDirectDrawSurface, arg1: LPRECT) -> HRESULT,
    >,
    pub Blt: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LPRECT,
    ...
    >,
    pub BltBatch: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LPDDBLTBATCH,
            arg2: DWORD,
    ...
    >,
    pub DeleteAttachedSurface: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: DWORD,
            arg2: LPDIRECTDRAWSURFACE,
    ...
    >,
    pub EnumAttachedSurfaces: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LPVOID,
    ...
    >,
    pub EnumOverlayZOrders: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: DWORD,
            arg2: LPVOID,
    ...
    >,
    pub GetAttachedSurface: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LPDDSCAPS,
            arg2: *mut LPDIRECTDRAWSURFACE,
    ...
    >,
    pub GetBltStatus: ::std::option::Option<
    ...
    >,
    pub GetClipper: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: *mut LPDIRECTDRAWCLIPPER,
        ) -> HRESULT,
    >,
    pub GetColorKey: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: DWORD,
            arg2: LPDDCOLORKEY,
    ...
    >,
    pub GetFlipStatus: ::std::option::Option<
        unsafe extern "stdcall" fn(This: *mut IDirectDrawSurface, arg1: DWORD) -> HRESULT,
    >,
    pub GetOverlayPosition: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LPLONG,
            arg2: LPLONG,
    ...
    >,
    pub GetPalette: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
    ...
    >,
    pub GetSurfaceDesc: ::std::option::Option<
    ...
    >,
    pub IsLost:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDrawSurface) -> HRESULT>,
    ...
    pub Restore:
        ::std::option::Option<unsafe extern "stdcall" fn(This: *mut IDirectDrawSurface) -> HRESULT>,
    pub SetClipper: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LPDIRECTDRAWCLIPPER,
        ) -> HRESULT,
    >,
    pub SetColorKey: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: DWORD,
            arg2: LPDDCOLORKEY,
    ...
    >,
    pub SetOverlayPosition: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LONG,
            arg2: LONG,
    ...
    >,
    pub SetPalette: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
    ...
    >,
    pub UpdateOverlay: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: LPRECT,
            arg2: LPDIRECTDRAWSURFACE,
    ...
    >,
    pub UpdateOverlayDisplay: ::std::option::Option<
        unsafe extern "stdcall" fn(This: *mut IDirectDrawSurface, arg1: DWORD) -> HRESULT,
    >,
    pub UpdateOverlayZOrder: ::std::option::Option<
        unsafe extern "stdcall" fn(
            This: *mut IDirectDrawSurface,
            arg1: DWORD,
            arg2: LPDIRECTDRAWSURFACE,
