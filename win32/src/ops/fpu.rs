...
pub fn fchs(x86: &mut X86, _instr: &Instruction) -> anyhow::Result<()> {
    *x86.regs.st_top() = -*x86.regs.st_top();
    Ok(())
}

pub fn fcos(x86: &mut X86, _instr: &Instruction) -> anyhow::Result<()> {
    let reg = x86.regs.st_top();
    *reg = reg.cos();
    Ok(())
}
pub fn fsin(x86: &mut X86, _instr: &Instruction) -> anyhow::Result<()> {
    let reg = x86.regs.st_top();
    *reg = reg.sin();
    Ok(())
}
pub fn fpatan(x86: &mut X86, _instr: &Instruction) -> anyhow::Result<()> {
...
pub fn fsqrt(x86: &mut X86, _instr: &Instruction) -> anyhow::Result<()> {
    let reg = x86.regs.st_top();
    *reg = reg.sqrt();
    Ok(())
}
...
pub fn faddp_sti_st0(x86: &mut X86, instr: &Instruction) -> anyhow::Result<()> {
...
pub fn fmul_sti_sti(x86: &mut X86, instr: &Instruction) -> anyhow::Result<()> {
    let y = *x86.regs.getst(instr.op1_register());
    let x = x86.regs.getst(instr.op0_register());
    *x *= y;
    Ok(())
...
pub fn fmulp_sti_st0(x86: &mut X86, instr: &Instruction) -> anyhow::Result<()> {
...
pub fn fdivrp_sti_st0(x86: &mut X86, _instr: &Instruction) -> anyhow::Result<()> {
    let x = *x86.regs.st_top();
    x86.regs.st_top += 1;
    *x86.regs.st_top() /= x;
    Ok(())
...
pub fn fxch_st0_sti(x86: &mut X86, instr: &Instruction) -> anyhow::Result<()> {
...
pub fn fnstsw_ax(x86: &mut X86, _instr: &Instruction) -> anyhow::Result<()> {
