...
pub fn cmp_rm32_r32(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm32(instr);
    let y = x86.regs.get32(instr.op1_register());
    sub32(x86, x, y);
}

pub fn cmp_r32_rm32(x86: &mut X86, instr: &Instruction) {
    let x = x86.regs.get32(instr.op0_register());
    let y = x86.op1_rm32(instr);
    sub32(x86, x, y);
}

pub fn cmp_rm32_imm32(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm32(instr);
    let y = instr.immediate32();
    sub32(x86, x, y);
}

pub fn cmp_rm32_imm8(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm32(instr);
...
pub fn cmp_rm16_imm16(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm16(instr);
    let y = instr.immediate16();
    sub16(x86, x, y);
}

pub fn cmp_rm16_imm8(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm16(instr);
    let y = instr.immediate8to16() as u16;
    sub16(x86, x, y);
}

pub fn cmp_rm8_imm8(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm8(instr);
    let y = instr.immediate8();
    sub8(x86, x, y);
}

pub fn cmp_rm8_r8(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm8(instr);
    let y = x86.regs.get8(instr.op1_register());
    sub8(x86, x, y);
}

pub fn cmp_r8_rm8(x86: &mut X86, instr: &Instruction) {
...
pub fn test_rm32_r32(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm32(instr);
    let y = x86.regs.get32(instr.op1_register());
    and32(x86, x, y);
}

pub fn test_rm32_imm32(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm32(instr);
    let y = instr.immediate32();
    and32(x86, x, y);
}

pub fn test_rm16_r16(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm16(instr);
    let y = x86.regs.get16(instr.op1_register());
    and16(x86, x, y);
}

pub fn test_rm8_r8(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm8(instr);
    let y = x86.regs.get8(instr.op1_register());
    and8(x86, x, y);
}

pub fn test_rm8_imm8(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm8(instr);
    let y = instr.immediate8();
    and8(x86, x, y);
}

pub fn bt_rm32_imm8(x86: &mut X86, instr: &Instruction) {
    let x = x86.op0_rm32(instr);
