...
pub mod bass {
    ...
    pub fn BASS_Init(machine: &mut Machine) {
        ...
        let arg1 =
            unsafe { <u32>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
        ...
        machine.x86.regs.eip = machine.mem.read_u32(machine.x86.regs.esp);
...
pub mod gdi32 {
    ...
    pub fn BitBlt(machine: &mut Machine) {
        ...
        let hdc =
            unsafe { <u32>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
        stack_offset += <u32>::stack_consumed();
        let x = unsafe { <u32>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
        stack_offset += <u32>::stack_consumed();
        let y = unsafe { <u32>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
        stack_offset += <u32>::stack_consumed();
        let cx =
            unsafe { <u32>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
        stack_offset += <u32>::stack_consumed();
...
pub mod kernel32 {
    ...
    pub fn GetModuleHandleA(machine: &mut Machine) {
        ...
        let lpModuleName = unsafe {
            <Option<&str>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn GetModuleHandleW(machine: &mut Machine) {
        let mut stack_offset = 4u32;
        let lpModuleName = unsafe {
            <Option<Str16>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn LoadLibraryExW(machine: &mut Machine) {
        ...
        stack_offset += <Option<Str16>>::stack_consumed();
        let hFile =
            unsafe { <HFILE>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
    ...
    pub fn GetProcAddress(machine: &mut Machine) {
        let mut stack_offset = 4u32;
        let hModule =
            unsafe { <HMODULE>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
    ...
    pub fn SetFilePointer(machine: &mut Machine) {
        ...
        let lpDistanceToMoveHigh = unsafe {
            <Option<&mut u32>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn ReadFile(machine: &mut Machine) {
        ...
        stack_offset += <HFILE>::stack_consumed();
        let lpBuffer = unsafe {
            <Option<&mut [u8]>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn WriteFile(machine: &mut Machine) {
        ...
        stack_offset += <HFILE>::stack_consumed();
        let lpBuffer = unsafe {
            <Option<&[u8]>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn QueryPerformanceCounter(machine: &mut Machine) {
        ...
        let lpPerformanceCount = unsafe {
            <Option<&mut u64>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn MultiByteToWideChar(machine: &mut Machine) {
        ...
        stack_offset += <u32>::stack_consumed();
        let cbMultiByte =
            unsafe { <i32>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
        stack_offset += <i32>::stack_consumed();
        let lpWideCharStr = unsafe {
            <Option<&mut [u16]>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn WriteConsoleW(machine: &mut Machine) {
        ...
        stack_offset += <HFILE>::stack_consumed();
        let lpBuffer = unsafe {
            <Option<&[u16]>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
...
pub mod user32 {
    ...
    pub fn RegisterClassA(machine: &mut Machine) {
        ...
        let lpWndClass = unsafe {
            <Option<&WNDCLASSA>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn CreateWindowExA(machine: &mut Machine) {
        ...
        stack_offset += <u32>::stack_consumed();
        let hWndParent =
            unsafe { <HWND>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
    ...
    pub fn PeekMessageA(machine: &mut Machine) {
        let mut stack_offset = 4u32;
        let lpMsg = unsafe {
            <Option<&mut MSG>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn TranslateMessage(machine: &mut Machine) {
        let mut stack_offset = 4u32;
        let lpMsg = unsafe {
            <Option<&MSG>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn DefWindowProcA(machine: &mut Machine) {
        ...
        stack_offset += <HWND>::stack_consumed();
        let msg = unsafe {
            <Result<WM, u32>>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset)
        };
    ...
    pub fn ShowCursor(machine: &mut Machine) {
        let mut stack_offset = 4u32;
        let _bShow =
            unsafe { <bool>::from_stack(&mut machine.mem, machine.x86.regs.esp + stack_offset) };
