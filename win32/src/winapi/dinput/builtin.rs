...
mod wrappers {
    ...
    pub unsafe fn DirectInputCreateA(sys: &mut dyn System, stack_args: u32) -> ABIReturn {
        unsafe {
            ...
            let result = dinput::DirectInputCreateA(
    ...
    pub unsafe fn IDirectInputDevice_Acquire(sys: &mut dyn System, stack_args: u32) -> ABIReturn {
        unsafe {
            ...
            let result = dinput::IDirectInputDevice::Acquire(
                &mut *(sys.machine() as *mut crate::Machine),
                this,
            );
            if let Some(mut __trace_record) = __trace_record {
    ...
    pub unsafe fn IDirectInputDevice_EnumObjects(
        ...
        unsafe {
            ...
            let result = dinput::IDirectInputDevice::EnumObjects(
                &mut *(sys.machine() as *mut crate::Machine),
                this,
                lpCallback,
                pvRef,
    ...
    pub unsafe fn IDirectInputDevice_SetCooperativeLevel(
        ...
        unsafe {
            ...
            let result = dinput::IDirectInputDevice::SetCooperativeLevel(
                &mut *(sys.machine() as *mut crate::Machine),
                this,
                hwnd,
                dwFlags,
    ...
    pub unsafe fn IDirectInputDevice_SetDataFormat(
        ...
        unsafe {
            ...
            let result = dinput::IDirectInputDevice::SetDataFormat(
                &mut *(sys.machine() as *mut crate::Machine),
                this,
                lpdf,
            );
    ...
    pub unsafe fn IDirectInputDevice_SetEventNotification(
        ...
        unsafe {
            ...
            let result = dinput::IDirectInputDevice::SetEventNotification(
                &mut *(sys.machine() as *mut crate::Machine),
                this,
                hEvent,
            );
    ...
    pub unsafe fn IDirectInputDevice_SetProperty(
        ...
        unsafe {
            ...
            let result = dinput::IDirectInputDevice::SetProperty(
                &mut *(sys.machine() as *mut crate::Machine),
                this,
                rguidProp,
                pdiph,
    ...
    pub unsafe fn IDirectInput_AddRef(sys: &mut dyn System, stack_args: u32) -> ABIReturn {
        unsafe {
            ...
            let result =
                dinput::IDirectInput::AddRef(&mut *(sys.machine() as *mut crate::Machine), this);
            if let Some(mut __trace_record) = __trace_record {
                __trace_record.exit(&result);
            }
            result.into()
    ...
    pub unsafe fn IDirectInput_EnumDevices(sys: &mut dyn System, stack_args: u32) -> ABIReturn {
        unsafe {
            ...
            let result = dinput::IDirectInput::EnumDevices(
                &mut *(sys.machine() as *mut crate::Machine),
                this,
                dwDevType,
                callback,
    ...
    pub unsafe fn IDirectInput_Release(sys: &mut dyn System, stack_args: u32) -> ABIReturn {
        unsafe {
            ...
            let result =
                dinput::IDirectInput::Release(&mut *(sys.machine() as *mut crate::Machine), this);
            if let Some(mut __trace_record) = __trace_record {
                __trace_record.exit(&result);
            }
            result.into()
